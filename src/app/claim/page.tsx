    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      <section className="reveal rounded-2xl border border-[var(--spanish-moss)]/25 bg-white p-6">
        ...
        <input
          ...
          className="mt-5 w-full rounded-xl border border-[var(--spanish-moss)]/35 bg-[var(--cream)] px-4 py-3"
        ...
        {selected ? (
          <div className="mt-6 rounded-xl bg-[var(--cream)] p-4">
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              ...
              <select className="rounded-lg border p-2" onChange={(e) => setForm((f) => ({ ...f, role: e.target.value as (typeof roles)[number] }))}>
                {roles.map((role) => (
